...
var diameter = 25;
//ooc
triangleObject[0] = new Triangle (500,1000,1200,500,1900,1000,100,50,80);
triangleObject[1] = new Triangle (0,0,300,300,600,0,10,50,80);
triangleObject[2]= new Triangle (2000,0,1800,200,1600,0,10,50,8);
...
function draw()
{
    ...
    triangleObject[2].display();
    //checkcollision();
}

//attempt to create collisions
/*function checkcollision(){
    for(var i = 0; i<3; i++){
        if(myXs[4] = triangleObject[i]) {
            myDiameters[4] += 10
        }
        if(myXs[4] = triangleObject[i]) {
                myDiameters[4] += 10
